...
| 2026-09-12 | session #6: analyze on REAL footage (cold) | owner's 604s 1280x720@30 badminton match (Bilibili 720p h264+aac) | 35.9 s wall | **0.06x realtime** | frame_diff + RMS + onsets, 1493 onsets; one-time, fingerprint-cached; the first real-footage run (all prior rows are synthetic) |
