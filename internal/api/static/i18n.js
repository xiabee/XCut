...
window.XCUT_I18N = {
  "zh": {
    ...
    "style's own": "跟随风格",
    "±0.12 s (product default)": "±0.12 秒（产品默认）",
    "off — keep the music, move nothing": "关闭——保留音乐，不动剪辑点",
    "music bed “{name}” at {bpm} BPM · {n} of {total} cuts landed on its beat": "背景音乐「{name}」{bpm} BPM · {n}/{total} 个剪辑点落在它的节拍上",
    ...
    "follow the region": "跟随区域",
    "The motion pick failed: {msg}": "运镜选择失败：{msg}",
