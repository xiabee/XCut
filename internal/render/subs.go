...
// Audio is stream-copied; the video is re-encoded once. The output is
...
func BurnSubtitles(ctx context.Context, tools media.Tools, inputPath, subsPath, outPath string) error {
